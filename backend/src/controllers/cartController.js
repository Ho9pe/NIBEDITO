...
const addItemToCart = async (req, res, next) => {
    try {
        ...
        // The client replaces its whole cart state with this response, so
        // items.product has to be populated here the way getCart, updateCartItem
        // and removeItemFromCart already do it. Without this the cart renders
        // each freshly added item with no name, price or image until the next
        // full page load refetches the cart.
        await cart.populate({
            path: 'items.product',
